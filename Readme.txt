A. Step to run the project:
	1. Deploy database: run command: node dbsetup.js 
		If there is no error, you should be able to see: "Database deployment completed" in the console
	2. Start API node server: run command: node server.js
		The server should be up and run on port port 3001
	3. Start client : run command : grunt serve
